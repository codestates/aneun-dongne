  ...
  return (
    <>
      <Styled.Body>
        ...
        <Styled.FocusTitleView className="focustitle" data-aos="fade-up" data-aos-duration="1000">
        ...
        <Styled.DiyTitleView className="diytitle" data-aos="fade-up" data-aos-duration="1000">
        ...
        <Styled.TitleEndView>
          ...
          <Styled.StartButton onClick={ToHome}>시작하기</Styled.StartButton>
          <div className="icons">{<Icon size={"80"} icon={angleDoubleDown} onClick={ToScrollBottom} />}</div>
        </Styled.TitleEndView>
